          ...
          {activeTab === "instructions" && (
            <div className="rc-card rc-instructions-card">
              <div className="rc-instructions-header">
                <FaFlag size={22} className="rc-flag-icon" />
                <div>
                  <h2>Report a Cheater</h2>
                  <p className="rc-small">
                    Submit a report (11 September Onwards) — we’ll review it
                    carefully.
                  </p>
                </div>
              </div>
              ...
              <div className="rc-instruction-section">
                ...
                <p>
                  All reports are reviewed manually and kept strictly
                  confidential. If verification is needed, we may reach out to
                  you, but your identity will always remain anonymous.
                </p>
              </div>
