      ...
      <div className="container">
        ...
        <div className="reg-tab-content">
          ...
          {activeTab === "instructions" && (
            <div
              className="reg-card reg-instructions-card"
              role="region"
              aria-labelledby="reg-instructions-title"
            >
              {/* Header */}
              <div className="reg-instructions-header">
                <FaUserPlus size={24} className="reg-icon" aria-hidden="true" />
                <div>
                  <h2 id="reg-instructions-title">Registration Instructions</h2>
